    ...
    switch (widget.layout) {
      case PageIndicatorLayout.NONE:
        return new NonePainter(
            widget, widget.preloadController.page ?? 0.0, index, _paint);
...
//      color: Colors.red,
  ...
  void _onController() {
    double page = widget.preloadController.page ?? 0.0;
  ...
  @override
  void initState() {
    widget.preloadController.addListener(_onController);
  ...
  void didUpdateWidget(PageIndicator oldWidget) {
    if (widget.preloadController != null) {
      if (widget.preloadController != oldWidget.preloadController) {
        oldWidget.preloadController.removeListener(_onController);
        widget.preloadController.addListener(_onController);
      }
    }
  ...
  @override
  void dispose() {
    widget.preloadController.removeListener(_onController);
